...
//any
var anything: any = "Can be anything"; //this can be any type and stores any value
...
//string array
var stringArray: string[] = ["TypeScript", "JavaScript", "Python"];
...
//readonly array
var readonlyArray: readonly number[] = [1, 2, 3, 4, 5];
console.log("Readonly Array:", readonlyArray);
//readonlyArray.push(6); // this will cause an error because the array is readonly

//object
var obj: object = { name: "TypeScript", version: 5.8 };
console.log("Object:", obj);
//tuple
var tuple: [number, string, boolean] = [1, "Tuple Example", true]; //type should be defined in order
...
var userInfo :{ userId:number, userName:string, userRole:string }=
{
    "userId":1,
    "userName":"usha",
    "userRole":"developer"
...
//optional parameters
var names:{ firstName: string, lastName?: string } = // defining an object with optional parameter
{
    firstName: "Usha",
...
var greet = (name: string, greeting: string = "Hello") => {
...
var logNumbers = (prefix: string, ...numbers: number[]) => {
    console.log(prefix);
